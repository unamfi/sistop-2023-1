...
def Menu():
    ...
    print("#".ljust(35," "),end="")
    #print("#".rjust(38," "))
    #print("#\thelp".ljust(23," "),end=" ")
    #print("-> Desplegar menú de ayuda".ljust(25," "),end="\t\t")
    #print("#\n#\tls".rjust(25," "),end=" ")
    print('#'.rjust(38," "))
    print("#\tls".ljust(25," "),end=" ")
...
def SeleccionarMenu(opcion):
    menuInteractivo = {'ls':Instruccion_ls,'cp':Instruccion_cp,'rm':Instruccion_rm,'defrag':Instruccion_defrag,'exit': exit}
...
def Instruccion_ls():
    ...
    for entrada in range(0,medidaEntradaDirectorio):
        ...
        if lectura != entradaNoUtilizados:
            ...
            print(f"Archivo: {lectura.split()[1].decode()}")
