...
- El primer cluster (#0) del pseudodispositivo es el
  ...
  *Ojo:* Por confusión míá, al plantear el proyecto el último valor
  (número de clusters en la unidad) aparecía sobreponiéndose al
  anterior (número de clusters en el directorio), del caracter 48
  al 51. El valor correcto es 50--54. ¡Agradezco a la compañera que me
  hizo ver el error, con excelente información para sustentarlo!
